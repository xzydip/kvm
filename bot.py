...
EMBED_IMAGE_URL = "https://cdn.discordapp.com/attachments/1539972707381284894/1543153630557769738/ChatGPT_Image_Aug_27_2026_04_44_28_PM.png?ex=6a9fb2cf&is=6a9e614f&hm=add8aabbbc7bfab22e344caf9c7b12db0d34af1a80a98332dce2b6c1b589bff3&"
KVM_IMAGE_URLS = {
...
async def create_vps(ctx, ram: str, cpu: str, disk: str, user: str):
    try:
        ...
        await ctx.send(embed=create_error_embed(
            "Invalid Specs",
            f"Use `{PREFIX}create <ram_gb> <cpu_cores> <disk_gb> @user` with whole numbers."
        ))
        return
    ...
    try:
        ...
        await ctx.send(embed=create_error_embed(
            "User Not Found",
            "Mention a server member or provide their user ID."
        ))
        return
